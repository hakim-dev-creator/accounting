...
window.toggleSecurity = (type) => {
    if (type === 'pin') appData.pinEnabled = document.getElementById('swPin').checked;
    else if (type === 'admin') appData.adminEnabled = document.getElementById('swAdmin').checked;
    saveToCloud();
};
...
// الدوال المساعدة للديون والتسبيقات
window.openAdvances = () => {
